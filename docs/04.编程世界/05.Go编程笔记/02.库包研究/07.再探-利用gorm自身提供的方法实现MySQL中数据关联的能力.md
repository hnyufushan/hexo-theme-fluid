...
// CreateUser 创建用户
func CreateUser() {
	User1 := &User{UserName: "eryajf1", NickName: "小于博客1"}
	User2 := &User{UserName: "eryajf2", NickName: "小于博客2"}
	User3 := &User{UserName: "eryajf3", NickName: "小于博客3"}
	User4 := &User{UserName: "eryajf4", NickName: "小于博客4"}
	User5 := &User{UserName: "eryajf5", NickName: "小于博客5"}
