...
// CreateDept 创建部门
func CreateDept() {
    Dept1 := &Dept{BaseModel: BaseModel{CreatedAt: time.Now(), UpdatedAt: time.Now(), DeletedAt: nil}, DeptID: 1, ParentID: 0, DeptPath: "/0/1", DeptName: "小于博客科技", Sort: 0, Leader: "zhangsan", Phone: "15638888888", Email: "zhangsan@eryajf.net", Status: "1", CreateBy: "", UpdateBy: ""}
    ...
    defer db.Close()
    db.Debug().Model(&Dept{}).Create(&Dept1) // INSERT INTO `dept` (`created_at`,`updated_at`,`deleted_at`,`dept_id`,`parent_id`,`dept_path`,`dept_name`,`sort`,`leader`,`phone`,`email`,`status`,`create_by`,`update_by`) VALUES ('2020-06-15 15:57:23','2020-06-15 15:57:23',NULL,1,0,'/0/1','小于博客科技',0,'zhangsan','15638888888','zhangsan@eryajf.net','1','','')
