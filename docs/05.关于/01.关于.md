...
那就用简短的话，介绍下本站：本站已托管，域名hnyufushan.top，是取`我的姓名`其中的字母而来，关于小于博客的由来，或许以后可另外再叙。日常主要还是更新一些与`运维技术`相关的文章，其他的没什么说的，保证所发是所用，绝对不会无脑复制，希望来到此小站的朋友，能够真正受益。平时也会发一些其他的随笔，如果不懒的话。
...
- 2017年8月13
  ...
  > 同时在万网购买了eryajf.net域名，域名取小于博客的拼音简写，应该不会更换，今后以及永远使用。
...
- 2022年7月
  ...
  > 博客接入了阿里云的CDN，由于博客每天流量并不低，导致费用很高，彼时发出过募捐活动(参看：[博客接入了CDN，请求大家江湖支援](http://fsvip.gitee.io/hexo-theme-fluid//pages/5f559d/))，感谢当时的读者朋友的支持。
