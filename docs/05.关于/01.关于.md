...
那就用简短的话，介绍下本站：本站托管于阿里云服务器，域名eryajf.net，是取`小于博客`其中的字母而来，关于小于博客的由来，或许以后可另外再叙。日常主要还是更新一些与`运维技术`相关的文章，其他的没什么说的，保证所发是所用，绝对不会无脑复制，希望来到此小站的朋友，能够真正受益。平时也会发一些其他的随笔，如果不懒的话。
