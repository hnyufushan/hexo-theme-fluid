...
> 笔记重构插件，能够让一篇长文，按照指定的分割标志切割成链接引用风格的文章。[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#note-refactor-obsidian)。
...
> 这个插件为黑曜石创建了一个简单的日历视图，用于在你的日常笔记之间可视化和导航。[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#calendar)。
