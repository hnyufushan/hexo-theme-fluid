...
> 增强版的快速切换与打开窗口，[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#quick-switcher-plus)。
...
> 编辑模式下高亮代码块，[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#cm-editor-syntax-highlight-obsidian)。
...
> 如说明介绍所言，[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#hider)。
...
> 提供了比核心插件中的模板更加强大的能力，[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#templater)。