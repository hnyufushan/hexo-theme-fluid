...
```html
<div style="display: block; position: absolute;left:0; width: 100%; height: 100%; --aspect-ratio:9/16; padding-bottom: calc(var(--aspect-ratio) * 100%);"><iframe src="http://fsvip.gitee.io/hexo-theme-fluid/" allow="fullscreen" style="position: absolute; top: 0px; left: 0px; height: 100%; width: 100%;"></iframe></div>
```
...
> 提供了快捷插入日期时间的功能，包括其他一些扩展能力，[详情参考](http://fsvip.gitee.io/hexo-theme-fluid//pages/6ed7fe/#natural-language-dates)。
...
> 可以将搜索到匹配条件的结果插入到当前笔记，功能与[text-expand](http://fsvip.gitee.io/hexo-theme-fluid//pages/58b1b7/#text-expand)类似。
