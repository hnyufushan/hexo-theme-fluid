...
有了如上介绍以及文档基础之后，我们选择jflint这个工具来进行检测，结合 [jenkins作为ci检测代码是否合并的实践](http://fsvip.gitee.io/hexo-theme-fluid//pages/615b71/#_1-gitlab%E9%85%8D%E7%BD%AE)此文章配置流水线ci，将共享库托管起来。
