...
- [Jenkins 声明式语法详解](http://fsvip.gitee.io/hexo-theme-fluid//pages/3298.html#_1-%E6%A1%86%E6%9E%B6%E4%BB%8B%E7%BB%8D%E3%80%82)
...
- 基础的环境一笔带过
    - Jenkins：2.343
    - ansible：2.10.8
    - Jenkins插件，参考[这篇文章](http://fsvip.gitee.io/hexo-theme-fluid//pages/2280.html)，所有都安装一下，否则可能本文进行不会顺利。
- 基础代码库
...
我在 [Jenkins 管理维护运维规范](http://fsvip.gitee.io/hexo-theme-fluid//pages/ef3aa8/) 一文中提到过两个规范：
